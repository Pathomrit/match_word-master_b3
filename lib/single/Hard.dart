...
class _Hard extends State<Hard> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Center(
            child: Text(
              matchedCard == 12 ? "You Win" : "You Lose",
              style: TextStyle(
                color: matchedCard == 12 ? Colors.green : Colors.red,
              ),
            ),
          ),
  ...
  void shuffleCard() {
    ...
    while (randomPositions.length < 12) {
    ...
    setState(() {
      ...
      timer?.cancel();
      isPlaying = false;
      isFlipped = List.filled(24, false);
    });
  }
